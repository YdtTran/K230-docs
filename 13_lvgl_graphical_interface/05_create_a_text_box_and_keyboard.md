# 5. Create a text box and keyboard

# Creating a text box and keyboard

Creating a text box and keyboardDetailed TutorialComplete code
...
The text box component is Textarea: [Text area (lv_textarea) — LVGL documentation](https://docs.lvgl.io/8.3/widgets/core/textarea.html)

The keyboard component is a Button matrix: [Button matrix (lv_btnmatrix) — LVGL documentation](https://docs.lvgl.io/8.3/widgets/core/btnmatrix.html)

First, we copy the code of the lvgl basic structure and add touch-related code.

We first declare a function to create a text box create_textarea() and a function to create a small keyboard create_btnm()
...
For the complete code, please refer to [Source Code Summary / 12.Lvgl / 05.lvgl_text]
