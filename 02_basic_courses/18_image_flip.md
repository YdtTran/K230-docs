...
Camera image flipCamera horizontal mirroring (flipping)API DescriptionRoutinesCamera flip verticallyAPI DescriptionRoutines
...
## Camera horizontal mirroring (flipping)
...
The code is located in [Source Code/02.Basic/18.1_sensor_hmirror.py]
...
The code is located in [Source Code/ 02.Basic /18.2_sensor_vflip.py]
