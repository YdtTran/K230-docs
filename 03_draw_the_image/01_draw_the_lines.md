...
Draw the lineExample IntroductionAPI DocumentationExample CodeExample running effect

## Example Introduction

In this section, we introduce the draw_line() method for drawing lines

## API Documentation

The `draw_line` function can be used to draw a line on an image.
...
```python
img.draw_line(10, 10, 100, 100, color=(255, 0, 0)) # Draw a red line

```

## Example Code

We use the Draw_line method to draw a Yahboom logo
