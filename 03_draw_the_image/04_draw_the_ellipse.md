...
Draw an ellipseExample IntroductionExample CodeRoutine running effect

## Example Introduction

In this section, we introduce the draw_ellipse() method for drawing an ellipse

The `draw_ellipse` function can be used to draw an ellipse on an image.
...
Parameter Explanation
  ...
  - `rx, ry`: The radius of the ellipse (x-axis and y-axis direction).
  - `color`: The color of the ellipse.
  - `thickness`: The thickness of the ellipse border (default is 1).

For details, please refer to the official documentation of OpenMV
...
​
 ...
        b = randint(0, 127) + 128
​
        # If the first argument is a scaler, this method requires passing x, y, radiusx, and radiusy.
