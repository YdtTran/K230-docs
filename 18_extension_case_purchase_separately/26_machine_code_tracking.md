# 5.Machine code tracking

# Machine code tracking
...
![image-20250603170101160](https://www.yahboom.com/public/upload/upload-html/1749210821/image-20250603170101160.png)
...
Place Apriltag_Track.py in the root directory of K230's sdcard and rename it to main.py, then reset or power on.
...
After K230 is initialized successfully, place the machine code in front of the camera and wait for three seconds for the robot to start tracking the machine code.
...
![image-20250530182310179](https://www.yahboom.com/public/upload/upload-html/1749210821/image-20250530182310179.png)
...
Visual_Line_Track: After recognizing the machine code, the robot waits for three seconds, records the current area size, calculates the x-axis offset and area offset, and finally controls the robot to move.
...
![aprilcode_track](https://www.yahboom.com/public/upload/upload-html/1749210821/aprilcode_track.png)