...
![图层-3 (10)](https://www.yahboom.net/public/upload/upload-html/1749538183/图层-3 (10).png)
...
Place Face_Track.py in the root directory of K230's sdcard and rename it to main.py, then reset or power on.
...
After K230 is initialized successfully, it will start to recognize faces. After waiting for three seconds, the robot will start to track faces.
...
![image-20250530182310179](https://www.yahboom.net/public/upload/upload-html/1749538183/image-20250530182310179.png)
...
Human_Face_Track: Three seconds after recognizing a face, the current face recognition frame size is recorded, and then the deviation between the x-axis and the area is calculated. The robot is controlled to reduce these deviations, thereby achieving the tracking effect and keeping the recognition frame in the middle of the screen.
...
![humanface](https://www.yahboom.net/public/upload/upload-html/1749538183/humanface.png)