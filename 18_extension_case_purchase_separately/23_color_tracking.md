...
Open the ProtocolHub project used by STM32, first check the beginning of the main.c file. The first thing to do is to change the number of MOTOR_TYPE to the motor you are using, and the second is to change color_mode to 2 to turn on the color tracking mode. After these two places are modified correctly, compile and burn, and finally reset or power on again.
3. 
