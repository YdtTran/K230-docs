...
![image-20250603170101160](https://www.yahboom.net/public/upload/upload-html/1749538409/image-20250603170101160.png)
...
Place License_Track.py in the root directory of K230's sdcard and rename it to main.py, then reset or power on.
...
When K230 is initialized successfully, it will start to recognize the license plate. After waiting for three seconds, the car will start to track the license plate.
...
![image-20250530182310179](https://www.yahboom.net/public/upload/upload-html/1749538409/image-20250530182310179.png)
...
Licence_Track: Three seconds after the license plate is recognized, the area of the current license plate recognition frame is recorded, and then the deviation value between the x-axis and the area is calculated. The car is controlled to reduce these deviations, thereby achieving the tracking effect and keeping the recognition frame in the middle of the screen.
...
![license](https://www.yahboom.net/public/upload/upload-html/1749538409/license.png)