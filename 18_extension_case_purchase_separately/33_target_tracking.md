...
![image-20250603170101160](https://www.yahboom.net/public/upload/upload-html/1749538434/image-20250603170101160.png)
...
Place Target_Tracking.py in the root directory of K230's sdcard and rename it to main.py, then reset or power on.
...
When K230 is initialized successfully, a green frame will appear in the center of the screen in the first 6 to 7 seconds. This is the learning process. Aim the green frame at the object we want to identify (here we take an ultrasonic module as an example) and wait for about 8 seconds. When the frame in the middle of the screen turns red, it means that it has entered the search and tracking stage.
...
![image-20250604161309882](https://www.yahboom.net/public/upload/upload-html/1749538434/image-20250604161309882.png)
...
![image-20250530182310179](https://www.yahboom.net/public/upload/upload-html/1749538434/image-20250530182310179.png)
...
Target_Track: Calculates and identifies the offset of the target on the x-axis, limits it, and controls the rotation tracking of the robot.
...
![image-20250604161258663](https://www.yahboom.net/public/upload/upload-html/1749538434/image-20250604161258663.png)