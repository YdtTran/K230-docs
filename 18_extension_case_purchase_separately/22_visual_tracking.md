...
![image-20250603170101160](https://www.yahboom.net/public/upload/upload-html/1749538373/image-20250603170101160.png)
...
Open the ProtocolHub project used by STM32, first check the beginning of the main.c file. The first thing to do is to change the number of MOTOR_TYPE to the motor you are using, and the second is to change color_mode to 1, which turns on the line patrol mode. After these two places are modified correctly, compile and burn, and finally reset or power on again.
...
Place the car on the patrol map, move the K230 module bracket to a suitable angle, and connect the power supply.
2. 

After K230 is initialized successfully, it will start to recognize the set color. After waiting for three seconds, the robot will start patrolling the line.
...
![image-20250530174129227](https://www.yahboom.net/public/upload/upload-html/1749538373/image-20250530174129227.png)

Here you can change it to the color you want to patrol:

![image-20250530174257343](https://www.yahboom.net/public/upload/upload-html/1749538373/image-20250530174257343.png)
...
![image-20250530182310179](https://www.yahboom.net/public/upload/upload-html/1749538373/image-20250530182310179.png)
...
void Visual_Line_Track(int x,int w)
{
 ...
    
    pid_output = PID_Calc(err);//计算差值的PID  PID to calculate the difference
...
Visual_Line_Track: After receiving data from K230, it will wait for three seconds, then start calculating the PID value of the line tracking, and finally control the car.
...
![Screenshot_2025-06-03-11-37-11-272_com.miui.mediaviewer](https://www.yahboom.net/public/upload/upload-html/1749538373/Screenshot_2025-06-03-11-37-11-272_com.miui.mediaviewer.jpg)