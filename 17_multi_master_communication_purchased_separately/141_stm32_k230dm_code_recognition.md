# 5. stm32_k230DM code recognition

# stm32_k230DM code recognition

stm32_k230DM code recognitionk230 and stm32 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the STM32F103C8T6 development board, and the corresponding routine path is [14.export\STM32-K230\05_STM32_k230_dmcode].
...
![image-20250430112815670](https://www.yahboom.net/public/upload/upload-html/1747384040/image-20250430112815670.png)
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747384040/image-20250429194108060.png)

1. The hex file generated by the STM32 burning routine.

![image-20250429194533860](https://www.yahboom.net/public/upload/upload-html/1747384040/image-20250429194533860.png)

1. 

The serial port assistant is set to the interface shown in the figure

![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747384040/2023060600004.png)
2. 

When the K230 camera screen recognizes the DM code, the serial port assistant will print out the information transmitted from k230 to stm32.
...
![image-20250430114226551](https://www.yahboom.net/public/upload/upload-html/1747384040/image-20250430114226551.png)