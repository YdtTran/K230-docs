...
k230DM code recognitionk230 and ESP32S3 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the ESP32S3 development board, and the corresponding routine path is [14.export\ESP32-K230\05_k230_dmcode].
...
![image-20250430184741900](https://www.yahboom.net/public/upload/upload-html/1747364617/image-20250430184741900.png)
...
void Pto_Data_Parse(uint8_t *data_buf, uint8_t num)
{
 ...
    printf("dmcode:x:%d, y:%d, w:%d, h:%d, msg:'%s', degress:%d\n", x, y, w, h, msg, degress);
}
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747364617/image-20250429194108060.png)
...
![image-20250430190335192](https://www.yahboom.net/public/upload/upload-html/1747364617/image-20250430190335192.png)

1. 

Set the serial port assistant to the interface shown in the figure and open the serial port of ESP32S3.

![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747364617/2023060600004.png)
2. 

When the K230 camera recognizes the DM code, the serial port assistant will print out the information transmitted from K230 to ESP32S3.
...
![image-20250430114226551](https://www.yahboom.net/public/upload/upload-html/1747364617/image-20250430114226551.png)