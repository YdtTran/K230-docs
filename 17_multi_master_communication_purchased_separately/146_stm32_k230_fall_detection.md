# 10. stm32_k230 fall detection

# stm32_k230 fall detection

stm32_k230 fall detectionk230 and stm32 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the STM32F103C8T6 development board, and the corresponding routine path is [14.export\STM32-K230\10_STM32_k230_falldown_detect].
...
![image-20250430112815670](https://www.yahboom.net/public/upload/upload-html/1747384224/image-20250430112815670.png)
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747384224/image-20250429194108060.png)

1. The hex file generated by the STM32 burning routine.

![image-20250429194533860](https://www.yahboom.net/public/upload/upload-html/1747384224/image-20250429194533860.png)

1. 

The serial port assistant is set to the interface shown in the figure

![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747384224/2023060600004.png)
2. 

When the K230 camera recognizes a human body, the serial port assistant will print out the information transmitted from k230 to stm32.
...
![image-20250430115527726](https://www.yahboom.net/public/upload/upload-html/1747384224/image-20250430115527726.png)