...
k230 gaze directionk230 and ESP32S3 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the ESP32S3 development board, and the corresponding routine path is [14.export\ESP32-K230\07_k230_eye_gaze].
...
![image-20250430184741900](https://www.yahboom.net/public/upload/upload-html/1747364659/image-20250430184741900.png)
...
void Pto_Data_Parse(uint8_t *data_buf, uint8_t num)
{
 ...
    int x1 = values[4];
    int y1 = values[5];
    printf("eye:x0:%d, y0:%d, x1:%d, y1:%d\n", x0, y0, x1, y1);
}
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747364659/image-20250429194108060.png)
...
![image-20250430190335192](https://www.yahboom.net/public/upload/upload-html/1747364659/image-20250430190335192.png)

1. 

Set the serial port assistant to the interface shown in the figure and open the serial port of ESP32S3.

![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747364659/2023060600004.png)
2. 
...
![image-20250430114651217](https://www.yahboom.net/public/upload/upload-html/1747364659/image-20250430114651217.png)