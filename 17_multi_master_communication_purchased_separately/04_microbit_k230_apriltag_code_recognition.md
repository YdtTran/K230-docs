# 4.microbit_k230 Apriltag code recognition

# microbit_k230 Apriltag code recognition

microbit_k230 Apriltag code recognitionK230 and microbit communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon

## K230 and microbit communication

### 1. Experimental Prerequisites

This tutorial uses microbit, and the corresponding routine path is [14.export\microbit-K230\4.Microbit_k230_apriltag].
...
![image-20250430112815670](https://www.yahboom.net/public/upload/upload-html/1753873212/Microbit.png) 

### 3. Main code explanation

![image-20250725181852239](https://www.yahboom.net/public/upload/upload-html/1753873212/image-20250725181852239.png) 
...
After K230 is connected to Canmv IDE, open the corresponding program, click [Save open script to CanMV board (as main.py)] on the toolbar, and then restart K230.
  ...
  ![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1753873212/image-20250429194108060.png)
...
![image-20250715182859861](https://www.yahboom.net/public/upload/upload-html/1753873212/image.png)  

1. The serial port assistant is set to the interface shown in the figure
![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1753873212/2023060600004.png)
2. When the K230 camera recognizes the AprilTag code, the serial port assistant will print out the information transmitted from K230 to microbit.
...
![image-20250717174253964](https://www.yahboom.net/public/upload/upload-html/1753873212/image-20250717174253964.png)