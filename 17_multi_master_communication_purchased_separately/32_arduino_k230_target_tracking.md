# 15.arduino_k230 target tracking

# arduino_k230 target tracking

arduino_k230 target trackingk230 and arduino communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
![image-20250430112815670](https://www.yahboom.net/public/upload/upload-html/1753872199/arduin.png)
...
After K230 is connected to Canmv IDE, open the corresponding program, click [Save open script to CanMV board (as main.py)] on the toolbar, and then restart K230.
  ...
  ![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1753872199/image-20250429194108060.png)
...
![image-20250430100319781](https://www.yahboom.net/public/upload/upload-html/1753872199/image-20250430100319781.png) 

![image-20250430100346748](https://www.yahboom.net/public/upload/upload-html/1753872199/image-20250430100346748.png) 
...
![image-20250716173038093](https://www.yahboom.net/public/upload/upload-html/1753872199/image-20250716173038093.png) 

1. The serial port assistant is set to the interface shown in the figure
![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1753872199/2023060600004.png)
2. When the K230 camera recognizes the target object, the serial port assistant will print out the information transmitted from K230 to Arduino.
...
- h: is the length of the identified box
 ...
 ![image-20250430121351893](https://www.yahboom.net/public/upload/upload-html/1753872199/image-20250430121351893.png)