# 9.arduino_k230 human body detection

# arduino_k230 human body detection

arduino_k230 human body detectionk230 and arduino communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon

## k230 and arduino communication

### 1. Experimental Prerequisites

This tutorial uses Arduino, and the corresponding routine path is [14.export\arduino-K230\9.Arduino_k230_person_detect].
...
![image-20250430112815670](https://www.yahboom.net/public/upload/upload-html/1753871808/arduin.png)
...
After K230 is connected to Canmv IDE, open the corresponding program, click [Save open script to CanMV board (as main.py)] on the toolbar, and then restart K230.
  ...
  ![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1753871808/image-20250429194108060.png)
...
![image-20250716152529499](https://www.yahboom.net/public/upload/upload-html/1753871808/image-20250716152529499.png) 

1. The serial port assistant is set to the interface shown in the figure
![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1753871808/2023060600004.png)
2. When the K230 camera recognizes a human body, the serial port assistant will print out the information transmitted from K230 to Arduino.
...
As shown in the figure below
  ![image-20250430115216204](https://www.yahboom.net/public/upload/upload-html/1753871808/image-20250430115216204.png)