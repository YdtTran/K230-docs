# 12.k230 gesture recognition

# k230 gesture recognition

k230 gesture recognitionK230 and Raspberry Pi communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the Raspberry Pi 5 development board, and the corresponding routine path is [14.export\Raspberrypi-K230\12_k230_gesture.py].
...
![image-20250430143649082](https://www.yahboom.net/public/upload/upload-html/1747381536/image-20250430143649082.png)
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747381536/image-20250429194108060.png)
...
```python
python3 12_k230_gesture.py

```

1. 

When the K230 camera image recognizes a palm and the palm makes a corresponding gesture, the terminal will parse and print out the information transmitted by the K230.
...
![image-20250430120239108](https://www.yahboom.net/public/upload/upload-html/1747381536/image-20250430120239108.png)