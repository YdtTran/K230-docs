...
k230 human body detectionk230 and ESP32S3 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the ESP32S3 development board, and the corresponding routine path is [14.export\ESP32-K230\09_k230_person_detect].
...
![image-20250430184741900](https://www.yahboom.net/public/upload/upload-html/1747364696/image-20250430184741900.png)
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747364696/image-20250429194108060.png)
...
![image-20250430190335192](https://www.yahboom.net/public/upload/upload-html/1747364696/image-20250430190335192.png)

1. Set the serial port assistant to the interface shown in the figure and open the serial port of ESP32S3.

  ![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747364696/2023060600004.png)

1. When the K230 camera recognizes a human body, the serial port assistant will print out the information transmitted from K230 to ESP32S3.
...
![image-20250430115216204](https://www.yahboom.net/public/upload/upload-html/1747364696/image-20250430115216204.png)