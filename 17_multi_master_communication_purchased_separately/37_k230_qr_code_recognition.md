...
k230 QR code recognitionk230 and ESP32S3 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the ESP32S3 development board, and the corresponding routine path is [14.export\ESP32-K230\03_k230_qrcode].
...
![image-20250430184741900](https://www.yahboom.net/public/upload/upload-html/1747364573/image-20250430184741900.png)
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747364573/image-20250429194108060.png)
...
![image-20250430190335192](https://www.yahboom.net/public/upload/upload-html/1747364573/image-20250430190335192.png)

1. 

Set the serial port assistant to the interface shown in the figure and open the serial port of ESP32S3.

![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747364573/2023060600004.png)
2. 

When the K230 camera recognizes the QR code, the serial port assistant will print out the information transmitted from K230 to ESP32S3.
...
![image-20250430113815052](https://www.yahboom.net/public/upload/upload-html/1747364573/image-20250430113815052.png)