...
k230 object detectionk230 and ESP32S3 communication1. Experimental Prerequisites2. Experimental wiring3. Main code explanation4. Experimental Phenomenon
...
This tutorial uses the ESP32S3 development board, and the corresponding routine path is [14.export\ESP32-K230\14_k230_object_detect].
...
![image-20250430184741900](https://www.yahboom.net/public/upload/upload-html/1747364806/image-20250430184741900.png)
...
void Pto_Data_Parse(uint8_t *data_buf, uint8_t num)
{
 ...
    int h = values[5];
​
    printf("object:x:%d, y:%d, w:%d, h:%d, class:'%s'\n", x, y, w, h, msg);
}
...
![image-20250429194108060](https://www.yahboom.net/public/upload/upload-html/1747364806/image-20250429194108060.png)
...
![image-20250430190335192](https://www.yahboom.net/public/upload/upload-html/1747364806/image-20250430190335192.png)

1. 

Set the serial port assistant to the interface shown in the figure and open the serial port of ESP32S3.

![image-2023060600004](https://www.yahboom.net/public/upload/upload-html/1747364806/2023060600004.png)
2. 
...
![image-20250430120851090](https://www.yahboom.net/public/upload/upload-html/1747364806/image-20250430120851090.png)